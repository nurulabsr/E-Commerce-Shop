...
@section('content')
   ...
   @include('Frontend.Home.Section.hot-deals')
    ...
    <!--============================
        CATEGORY PRODUCT SLIDER PART ONE START  
    ==============================-->
   @include('Frontend.Home.Section.category-product-slider-one')
    <!--============================
        CATEGORY PRODUCT SLIDER PART ONE END  
    ==============================-->


    <!--============================
        CATEGORY PRODUCT SLIDER PART TWO START  
    ==============================-->
    @include('Frontend.Home.Section.category-product-slider-two')
    <!--============================
        CATEGORY PRODUCT SLIDER PART TWO PART END  
    ==============================-->
  ...
  @include('Frontend.Home.Section.home-service')
    ...
    <!--============================
        HOME BLOGS START
    ==============================-->
  @include('Frontend.Home.Section.home-blog')
    <!--============================
        HOME BLOGS END
    ==============================-->    
@endsection