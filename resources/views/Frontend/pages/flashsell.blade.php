    ...
    <section id="wsus__daily_deals">
        <div class="container">
            <div class="wsus__offer_details_area">
                <div class="row">
                    <div class="col-xl-6 col-md-6">
                        <div class="wsus__offer_details_banner">
                            <img src="{{asset('FrontendData/images/offer_banner_2.png')}}" alt="offrt img" class="img-fluid w-100">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="wsus__offer_details_banner">
                            <img src="{{asset('FrontendData/images/offer_banner_3.png')}}" alt="offrt img" class="img-fluid w-100">
                            <div class="wsus__offer_details_banner_text">
                ...
                <div class="m-5">
                    @if ($flashsellItems->hasPages())
                    {{$flashsellItems->links()}}
                @endif
                </div>
            </div>
        </div>
